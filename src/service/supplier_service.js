...
export const createSupplier = serviceHandler(
    ...
    async (supplierData = {}, ctx) => {
        ...
        if (existCode)
            throw new AppError('El proveedor ya existe', 400, CODES.SUPPLIER.ALREADY_EXISTS);
...
export const updateSupplier = serviceHandler(
    ...
    async (supplierData = {}, ctx) => {
        ...
        if (existCode && existCode.id !== supplierData.id)
            throw new AppError('El proveedor con este codigo ya existe', 400, CODES.SUPPLIER.ALREADY_EXISTS);
